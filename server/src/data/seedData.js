...
export const initialOrders = [
  {
    ...
    items: [
      { id: 'prod-tomato', name: 'Desi Red Tomato', portion: '1 kg', price: 36 },
      { id: 'prod-palak', name: 'Hydroponic Spinach', portion: '500 g', price: 20 },
      { id: 'prod-coriander', name: 'Desi Coriander', portion: '1 bunch', price: 15 }
    ],
    subtotal: 71,
    discount: 0,
    deliveryFee: 15,
